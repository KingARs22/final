...
// Middleware
app.use(cors({
  origin: [ 'http://localhost:3000','https://final-incy.vercel.app/'], // Frontend URLs
  credentials: true,
  ...
  app.use(
    session({
      ...
      store: MongoStore.create({
        mongoUrl: "mongodb+srv://akshatrangari2004:PI7n9IiPZAGrPLKX@cluster0.u87fq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0",
...
// MongoDB Connection
const uri = "mongodb+srv://akshatrangari2004:PI7n9IiPZAGrPLKX@cluster0.u87fq.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0";
...
app.get('/product/:productId', async (req, res) => {
  try {
    ...
    // Use an object as the filter for findOne
    const product = await Product.findOne({ productId }); // Assuming `productId` is a field in your schema
